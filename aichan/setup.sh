...
aichan ALL=(root) NOPASSWD: /usr/bin/docker exec *
aichan ALL=(root) NOPASSWD: /usr/bin/docker cp
aichan ALL=(root) NOPASSWD: /usr/bin/docker cp *
aichan ALL=(root) NOPASSWD: /usr/bin/docker save
aichan ALL=(root) NOPASSWD: /usr/bin/docker save *
aichan ALL=(root) NOPASSWD: /usr/bin/docker load
aichan ALL=(root) NOPASSWD: /usr/bin/docker load *
aichan ALL=(root) NOPASSWD: /usr/bin/docker export
aichan ALL=(root) NOPASSWD: /usr/bin/docker export *
aichan ALL=(root) NOPASSWD: /usr/bin/docker import
aichan ALL=(root) NOPASSWD: /usr/bin/docker import *
aichan ALL=(root) NOPASSWD: /usr/bin/docker build
aichan ALL=(root) NOPASSWD: /usr/bin/docker build *
aichan ALL=(root) NOPASSWD: /usr/bin/docker rm
aichan ALL=(root) NOPASSWD: /usr/bin/docker rm *
aichan ALL=(root) NOPASSWD: /usr/bin/docker rmi
aichan ALL=(root) NOPASSWD: /usr/bin/docker rmi *
aichan ALL=(root) NOPASSWD: /usr/bin/docker tag
aichan ALL=(root) NOPASSWD: /usr/bin/docker tag *
